      ...
      <div class="row m-0">
        ...
        <div class="col-3">
          <b-button
            ...
            @click="saveUser('b-toaster-bottom-right')"
          >
            <img
              class="cross-img"
            ...
            <tr v-for="item in computed_filter" :key="item.id">
              ...
              <td>
                <img
                  ...
                  alt="edit"
                  @click="showModal(item.id.toString())"
                />
              </td>
              <td>
                <img
                  ...
                  alt="del"
                  @click="deleteUser(item.id, 'b-toaster-bottom-right')"
                />
              </td>
              <!-- MODAL -->
              <b-modal size="lg" :id="item.id.toString()">
                ...
                <template v-slot:modal-footer>
                  <b-button
                    class="btn-cancel"
                    @click="cancelEdit(item.id.toString())"
                  >
                    Cancelar
                  </b-button>
                  <b-button
                    class="btn-enviar"
                    @click="
                      editing(item.id.toString(), 'b-toaster-bottom-right')
                    "
                  >
                    Salvar
                  </b-button>
